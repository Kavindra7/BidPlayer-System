                        ...
                        <div class="col-12 md:col-3 lg:col-2 " >
                            <div class="">
                                <template v-if="$auth.canView('/permissions/add')">
                                    <Button label="Add New Permissions" icon="pi pi-plus"  @click="app.openPageDialog({ page: 'permissions/add', url: `/permissions/add` , closeBtn: true })"  class="w-full bg-primary "  />
                                </template>
                            </div>
                        </div>
