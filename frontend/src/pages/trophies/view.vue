                                                ...
                                                <div class="col-12">
                                                    <div class="" :class="{ 'card': !isSubPage }">
                                                        <div class="grid align-items-center">
                                                            ...
                                                            <div class="col font-bold">{{ item.trophy_name }}</div>
                                                        </div>
                                                        <hr />
                                                        <div class="grid align-items-center">
                                                            <div class="col">
                                                            ...
                                                            <div class="col font-bold">
                                                                <Button class="p-button-text" icon="pi pi-eye" label="Team 1 Info" v-if="item.team_1" @click="app.openPageDialog({ page: 'teams/view', url: `/teams/view/${item.team_1}` , closeBtn: true })" />
                                                            </div>
                                                        </div>
                                                        <hr />
                                                        <div class="grid align-items-center">
                                                            ...
                                                            <div class="col font-bold">
                                                                <Button class="p-button-text" icon="pi pi-eye" label="Team 2 Info" v-if="item.team_2" @click="app.openPageDialog({ page: 'teams/view', url: `/teams/view/${item.team_2}` , closeBtn: true })" />
                                                            </div>
                                                        </div>
                                                        <hr />
                                                        <div class="grid align-items-center">
                                                        ...
                                                        <div class="grid align-items-center">
                                                            ...
                                                            <div class="col font-bold">{{ item.prize }}</div>
                                                        </div>
                                                        <hr />
...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'trophiesview',
		},
		apiPath: {
			type: String,
			default: 'trophies/view',
		},
		editButton: {
			type: Boolean,
			default: true,
	...
	onMounted(()=>{ 
		const pageTitle = "Trophies Details";
